  ...
  return (
    <form className="max-w-[1440px] p-6 mx-auto md:ml-42 md:mr-42" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 mx-auto">
        <div className="mb-4">
          <input className="text-primary focus:outline-none focus:border-[#FF2A70] focus:ring-0  focus:bg-black bg-black border border-primary placeholder-primary p-4 w-full" id="name" placeholder="Your Name" {...register("name", { required: "Name is required" })} />
      ...
      <div className=" mb-4">
        <textarea className="placeholder-primary border border-primary focus:outline-none focus:border-[#FF2A70] focus:ring-0 focus:bg-black bg-black p-4 w-full h-70" id="comment" placeholder="Your Comment" {...register("comment", { required: "Comment is required" })}></textarea>
