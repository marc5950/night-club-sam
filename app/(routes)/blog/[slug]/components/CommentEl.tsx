...
const CommentEl = ({ comments }: CommentElProps) => {
  if (!comments || comments.length === 0) {
    return (
      <div className="max-w-[1440px] md:p-0 mx-auto p-6">
        {/* <h4 className="text-primary font-bold text-2xl mb-4 uppercase">No comments yet</h4> */}
      </div>
    );
  }

  return (
    <div className="max-w-[1020px] md:ml-42 mx-auto md:p-0 pl-4">
