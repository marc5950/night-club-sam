  ...
  return (
    <section className='relative w-full h-20 md:h-[272px]'>
      <Image
        ...
        width={1440}
        height={272}
        className='object-cover w-full h-auto md:h-[272px] brightness-15'
      />
      <div className='absolute inset-0 flex flex-col items-center justify-center z-1 mt-15 md:mt-0'>
